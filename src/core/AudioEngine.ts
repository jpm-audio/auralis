...
import Ticker from "../components/timeline/Ticker";
import { Utils } from "../utils/utils";
import { AudioCatalogItem, AudioLoadOptions, AudioGlobalConfig } from "./types";
...
export class AudioEngine {
    ...
    public constructor() {
        ...
        this._ticker = new Ticker({ audioContext: this._context });
