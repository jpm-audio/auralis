import { SoundSpriteData } from "@pixi/sound";
import { ParamAutomationOptions } from "../components/parameters/types";
import { AudioMultipleClipMode } from "audio/components/channels/types";
