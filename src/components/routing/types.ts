import { IAudioBus, IAudioBusOptions } from "../channels/types";

/**
 * Interface for the options used to create a routing handler
 */
export interface IRoutingHandlerOptions {
...
export interface IRoutingHandler {
	 ...
	 */
	readonly output: IAudioBus | undefined;
	/**
	 ...
	 */
	getInput(name: string): IAudioBus | undefined;
	 ...
	 */
	connectOutput(destination: IAudioBus): IAudioBus | undefined;
...
export interface IAudioMixer {
	 ...
	 */
	createBus(options: IAudioBusOptions): IAudioBus;
}
