 ...
 */
export default class ValueRelation
    extends EventEmitter
    implements IValueRelation
{
    /**
	 ...
	 */
    protected _transferFunction: TParameterRelation;
    /**
	 ...
	 * This function takes the input parameter and returns a number.
	 */
    public set transferFunction(value: TParameterRelation) {
	 ...
	 */
    constructor(options: IValueRelationOptions) {
        super();
        ...
        this._inputParameter.on(eParameterEvent.UPDATE, this._onUpdate, this);
        this._onUpdate();
    }
    /**
    ...
    protected _onUpdate = (): void => {
        ...
        this.emit(eValueRelationEvent.UPDATE, this);
    };
    /**
     ...
     */
    public destroy(): void {
        this._inputParameter.off(eParameterEvent.UPDATE, this._onUpdate, this);
    }
}
