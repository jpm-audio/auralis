 ...
 */
export default class AudioClip extends AudioBus implements IPlayable {
    /**
    ...
    constructor(options: IAudioClipOptions) {
        ...
        this.on(eAudioBusEvents.VOLUME_CHANGE, this._onVolumeChange, this);
        this.on(eAudioBusEvents.PAN_CHANGE, this._onPanChange, this);
        this.on(eAudioBusEvents.MUTE_CHANGE, this._onMuteChange, this);
    }
    /**
	 ...
	 * @param {IAudioBusEventInfo} info - The event info object
	 */
    protected _onPanChange(info: IAudioBusEventInfo): void {
        if (this._soundInstance) {
	 ...
	 * @param {IAudioBusEventInfo} info - The event info object
	 */
    protected _onMuteChange(info: IAudioBusEventInfo): void {
        if (this._soundInstance) {
    ...
    public destroy(): void {
        ...
        this.off(eAudioBusEvents.VOLUME_CHANGE, this._onVolumeChange, this);
        this.off(eAudioBusEvents.PAN_CHANGE, this._onPanChange, this);
        this.off(eAudioBusEvents.MUTE_CHANGE, this._onMuteChange, this);
