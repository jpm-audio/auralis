...
import { TNumberRange, TCurveFunction } from "../types";
import { IRoutingHandler } from "../routing/types";
import Parameter from "../parameters/Parameter";

/**
 * Enumeration of audio bus events
 */
export enum eAudioBusEvents {
 ...
 */
export interface IAudioBusEventInfo {
	/**
	 * Event triggered
	 */
 ...
 */
export interface IAudioBus extends EventEmitter {
	/**
	 ...
	 */
	readonly routing: IRoutingHandler;
	/**
 ...
 */
export interface IAudioClipOptions extends IAudioBusOptions {
	/**
 ...
 */
export interface IClipListItem {
	/**
 ...
 */
export interface IAudioMultipleClipOptions extends IAudioClipOptions {
	clipList: IClipListItem[];
