...
import type { AudioTickerOptions } from './types';
...
export class AudioTicker extends EventEmitter {
    ...
    private nextTickTime: number;         // Next tick timestamp (audioContext.currentTime)
   ...
   */
     ...
     */
    public add(callback: TickCallback, audioContext?: any): AudioTicker {
     ...
     */
    public remove(callback: TickCallback, audioContext?: any): AudioTicker {
