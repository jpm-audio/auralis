...
import {
    ParameterEvent,
    ValueRelationEvents,
    type ParameterRelationType,
    type ValueRelationInterface,
...
export class ValueRelation
    ...
    implements ValueRelationInterface
{
    /**
	 ...
	 */
    protected _transferFunction: ParameterRelationType;
    /**
	 ...
	 * This function takes the input parameter and returns a number.
	 */
    public set transferFunction(value: ParameterRelationType) {
    ...
    protected _onUpdate = (): void => {
        ...
        this.emit(ValueRelationEvents.UPDATE, this);
    };
    /**
