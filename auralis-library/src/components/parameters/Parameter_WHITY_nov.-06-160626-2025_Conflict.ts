...
import {
    ParamAutomationEvent,
    ParameterEvent,
    ParameterType,
    ValueRelationEvent,
    type IParameterOptions,
...
export class Parameter extends EventEmitter {
    ...
    protected _updateValue(value: number): void {
        ...
        if (this._type === ParameterType.DISCRETE) {
        ...
        if (newValue !== this._value) {
            ...
            this.emit(ParameterEvent.UPDATE, this);
        }
    }
    /**
