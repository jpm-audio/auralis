...
import { RoutingHandler } from "@/components/routing/RoutingHandler";
import type { RoutingHandlerOptions } from "@/components/routing/types";
 ...
 */
export class AudioBus extends EventEmitter implements AudioBus {
    /**
	 * Name of the bus
	 */
