import { AUDIO_CLIP_OPTIONS_DEFAULT } from "@/components/constants/AudioClipOptions";
import type { Playable } from "@/components/types";
import type { AudioClipOptions, AudioBusEventInfo } from "./types";
import { AudioBusEvents } from "./types";
import { AudioBus } from "./AudioBus";
import { VirtualPlayer } from "@/components/timeline";
import { Deferred, Pitch, Interpolation } from "@/utils";
import {
    ParamAutomationEvents,
    ParameterType,
    type FadeConfig,
} from "@/components/parameters/types";
import { FadeAutomation, Parameter } from "@/components/parameters";
import { GLOBAL_CONFIG } from "@/core/AudioGlobalConfig";
import { sound, type MediaInstanceInterface } from "@/sound";
 ...
 */
export class AudioClip extends AudioBus implements Playable {
    /**
	 ...
	 * @type {MediaInstanceInterface | null}
	 * @private
	 */
    protected _soundInstance: MediaInstanceInterface | null = null;
    /**
	 ...
	 * @returns {MediaInstanceInterface | null} - The sound instance of the audio clip
	 */
    public get soundInstance(): MediaInstanceInterface | null {
	 ...
	 * @returns {FadeConfig} - The fade in configuration of the audio clip
	 */
    public set fadeInConfig(config: FadeConfig) {
        this._fadeAutomation.inConfig = config;
    }
    /**
	 * Get the fade out configuration of the audio clip
	 * @returns {FadeConfig} - The fade out configuration of the audio clip
	 */
    public set fadeOutConfig(config: FadeConfig) {
	 ...
	 * @returns {FadeConfig} - The fade in configuration of the audio clip
	 */
    public get fadeInConfig(): FadeConfig {
	 ...
	 * @returns {FadeConfig} - The fade out configuration of the audio clip
	 */
    public get fadeOutConfig(): FadeConfig {
