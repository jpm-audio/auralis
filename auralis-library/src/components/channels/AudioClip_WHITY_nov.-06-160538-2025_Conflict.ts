import { Deferred, Interpolation, Pitch } from "@/utils";
import { FadeAutomation } from "@/components/parameters/FadeAutomation";
import { VirtualPlayer } from "@/components/timeline/VirtualPlayer";
import type { Playable } from "@/components/types";
import { AudioBus } from "./AudioBus";
import { ParamAutomationEvent, ParameterType, type IFadeConfig, type Parameter } from "../parameters";
import { AudioBusEvents, type AudioBusEventInfo, type AudioClipOptions } from "./types";
import { AUDIO_CLIP_OPTIONS_DEFAULT } from "../constants";
import { audioEngine, GLOBAL_CONFIG } from "@/core";
