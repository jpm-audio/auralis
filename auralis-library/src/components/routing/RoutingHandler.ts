...
// } from "../channels";
// import type AudioBus from "../channels/AudioBus";
...
//  */
// export class RoutingHandler implements RoutingHandlerInterface {
//     /**
...
// 	 */
//     constructor(options: RoutingHandlerOptions) {
...
// 	 * @param previous
// 	 */
//     protected _onOutputVolumeChange(eventInfo: AudioBusEventInfo): void {
...
//         const info: AudioBusEventInfo = {
//             ...eventInfo,
//             interpolatedValue: this._interpolatedVolume,
//         };
//         this._owner.emit(AudioBusEvents.VOLUME_CHANGE, info);
//     }
//     /**
...
// 	 * @param previous
// 	 */
//     protected _onOutputMuteChange(eventInfo: AudioBusEventInfo): void {
//         // Update interpolated value
...
//         };
//
//         this._owner.emit(AudioBusEvents.MUTE_CHANGE, info);
//     }
//     /**
...
// 	 * @param previous
// 	 */
//     protected _onOutputPanChange(eventInfo: AudioBusEventInfo): void {
//         // Update interpolated value
...
//         };
//
//         this._owner.emit(AudioBusEvents.PAN_CHANGE, info);
//     }
//     /**
